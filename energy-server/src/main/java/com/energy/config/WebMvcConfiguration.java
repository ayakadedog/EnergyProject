...
import com.energy.interceptor.JwtTokenAdminInterceptor;
import com.energy.interceptor.JwtTokenUserInterceptor;
...
public class WebMvcConfiguration extends WebMvcConfigurationSupport {
    ...
    protected void extendMessageConverters(List<HttpMessageConverter<?>> converters) {
        ...
        messageConverter.setObjectMapper(new com.energy.json.JacksonObjectMapper());
